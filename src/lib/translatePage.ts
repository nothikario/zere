...
const translations: [string, string][] = [
  ...
  ['Какой будет кадр?', 'Choose the framing'], ['Выбери, какая часть персонажа попадёт в арт.', 'Choose how much of the character appears in the artwork.'],
  ...
  ['В полный рост', 'Full body'], ['По пояс', 'Waist-up'], ['По плечи', 'Shoulders-up'], ['Крупно голова', 'Head close-up'],
