...
type Props = { reference: ArtReference; onDelete: () => void; onGenerated: (path: string, field: 'image_path' | 'final_art_path') => void; onReward: () => void };

export function ReferenceCard({ reference, onDelete, onGenerated, onReward }: Props) {
